...
*
*	version 1.1.6 (with WASM support, cached filename translation & track switch bugfix, "internal filename"
...
var fetchSamples= function (e) {
	...
	// in order to pervent the dumbshit Chrome GC from detroying it eventually (might no longer be
	// necessary in recent versions)

	var f= window.player['genSamples'].bind(window.player);
	f(e);
};
...
*/
function AudioBackendAdapterBase(channels, bytesPerSample) {
...
*/
var EmsHEAP16BackendAdapter = (function(){ var $this = function (backend, channels) {
...
*       "notifyAdapterReady" is triggered so that the player is notified of the change.
*/
var EmsHEAPF32BackendAdapter = (function(){ var $this = function (backend, channels) {
...
var ScriptNodePlayer = (function () {
	...
	*/
	function PlayerImpl(backendAdapter, basePath, requiredFiles, spectrumEnabled, onPlayerReady, onTrackReadyToPlay, onTrackEnd, onUpdate, externalTicker, bufferSize) {
